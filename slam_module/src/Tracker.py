...
class Tracker(object):
    ...
    def optimize_cam_in_batch(self, camera_tensor, gt_color, gt_depth, gt_belief, batch_size, optimizer):
        """
        ...
        batch_rays_o, batch_rays_d, batch_gt_depth, batch_gt_color, _ = get_samples(
            Hedge, H-Hedge, Wedge, W-Wedge, batch_size, H, W, fx, fy, cx, cy, c2w, gt_depth, gt_color, gt_belief, self.device)
        if self.nice:
    ...
    def run(self):
        ...
        for idx, gt_color, gt_depth, gt_c2w, gt_belief in pbar:
            if not self.verbose:
            ...
            gt_color = gt_color[0]
            gt_c2w = gt_c2w[0]
            gt_belief = gt_belief[0]
            print("gt_color,gt_belief", gt_color.shape, gt_belief.shape)
            ...
            if idx == 0 or self.gt_camera:
                ...
                for cam_iter in range(self.num_cam_iters):
                    ...
                    loss = self.optimize_cam_in_batch(
                        camera_tensor, gt_color, gt_depth, gt_belief, self.tracking_pixels, optimizer_camera)
