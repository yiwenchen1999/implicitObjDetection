...
class Renderer(object):
    ...
    def render_batch_ray(self, c, decoders, rays_d, rays_o, device, stage, gt_depth=None):
        ...
        # print("N_samples, N_surface, N_importance: ")
        # print(N_samples, N_surface, N_importance)

        N_rays = rays_o.shape[0]
        # print("input rays: " + str(rays_o.shape))


        # ----IF COARSE, set N depth = 0, else, set gt_depth_samples and near--------------
        if stage == 'coarse':
            gt_depth = None
        if gt_depth is None:
            N_surface = 0
        ...
        with torch.no_grad():
            ...
            far_bb += 0.01
            # print("t: "+ str(t.shape)+ " far_bb: "+ str(far_bb.shape))
        ...
        if gt_depth is not None:
            ...
            far = far_bb
        #——------------------sampling to get where rays end-----------------------------------
        if N_surface > 0:
            if False:
