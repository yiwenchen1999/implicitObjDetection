...
if __name__=='__main__':
    ...
    for filename in directories:
        ...
        # if True:
            ...
            h_im.save("/gpfs/data/ssrinath/ychen485/implicitSearch/implicitObjDetection/perpixel3/"+filename[:-4]+"_heat_test25.png")
            np.save("/gpfs/data/ssrinath/ychen485/implicitSearch/implicitObjDetection/perpixel3/"+filename[:-4]+"_heat_test25", heatmap)
