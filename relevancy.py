...
if __name__=='__main__':
    ...
    for filename in directories:
        ...
        if True:
            ...
            o_im.save("/gpfs/data/ssrinath/ychen485/implicitSearch/adaptingCLIPtesting/outputLego/"+filename+".png")
            h_im.save("/gpfs/data/ssrinath/ychen485/implicitSearch/adaptingCLIPtesting/outputLego/"+filename[-4:]+"_heat.png")
