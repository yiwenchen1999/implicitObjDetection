...
if __name__=='__main__':
    ...
    for filename in directories:
        ...
        # if True:
            ...
            o_im.save("/gpfs/data/ssrinath/ychen485/implicitSearch/implicitObjDetection/octseg2/"+filename)
            h_im.save("/gpfs/data/ssrinath/ychen485/implicitSearch/implicitObjDetection/octseg2/"+filename[:-4]+"_heat_comp_511.png")
