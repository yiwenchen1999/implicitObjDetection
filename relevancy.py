...
if __name__=='__main__':
    ...
    for filename in directories:
        ...
        # if True:
            ...
            o_im.save("/gpfs/data/ssrinath/ychen485/implicitSearch/implicitObjDetection/octseg2c/"+filename)
            h_im.save("/gpfs/data/ssrinath/ychen485/implicitSearch/implicitObjDetection/octseg2c/"+filename[:-4]+"_heat_comp_55.png")
