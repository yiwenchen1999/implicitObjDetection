...
if __name__=='__main__':
    ...
    for filename in directories:
        ...
        # if True:
            ...
            o_im.save("/gpfs/data/ssrinath/ychen485/implicitSearch/implicitObjDetection/perpixel2/"+filename)
            h_im.save("/gpfs/data/ssrinath/ychen485/implicitSearch/implicitObjDetection/perpixel2/"+filename[:-4]+"_heat_6_40.png")
            np.save("/gpfs/data/ssrinath/ychen485/implicitSearch/implicitObjDetection/perpixel2/"+filename[:-4]+"_heat_6_40", heatmap)
