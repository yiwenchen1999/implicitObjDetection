...
if __name__=='__main__':
    ...
    for filename in directories:
        ...
        if True:
            ...
            save_query("a cup with a handle", image_clip_feature_normalized, 5)
            save_query("the handle", image_clip_feature_normalized, 5)
            save_query("a cup", image_clip_feature_normalized, 5)
            save_query("red", image_clip_feature_normalized, 5)
            save_query("the handle on the cup", image_clip_feature_normalized, 5)
            # # image_id = "00080"
